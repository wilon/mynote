                ...
                <td align="left"><textarea cols="55" rows="25" readonly="readonly">
{
    ...
    "data": [
        ...
        },
        {
            ...
            "name": "CCTV-5",
            "namecolor": "#00CC33",
            "icon": "<a href=\"forum.php?mod=forumdisplay&fid=39\"><img src=\"data/attachment/common/d6/common_39_icon.jpg\" align=\"left\" alt=\"\" /></a>"
        },
        ...
    ],
    "code": 20000
            ...
            <tr>
                ...
                <td align="left" width="60%">
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                        ...
                        <tr><td class="pad-left-50">namecolor</td><td>板块名颜色</td></tr>
                ...
                <table>
                    <form action="./t_forum_postlist.php" method="post">
                        <tr>
                            ...
                            <td><input type="text" name="fid" value="39" /></td>
                        </tr>
                        <tr>
                ...
                <table>
                    <form action="./t_forum_viewthread.php" method="post">
                        <tr>
                            ...
                            <td><input type="text" name="tid" value="64" /></td>
                        </tr>
                        <tr>
                            <td width="150px">用户ID(uid)</td>
                            <td><input type="text" name="uid" value="2" /></td>
            ...
            <tt>4. 发布主题 （./t_forum_newthread.php）POST</tt>
                <table>
                    <form action="./t_forum_newthread.php?action=newthread" method="post">
                        <tr>
                            <td width="150px">版块ID(fid)</td>
                            <td><input type="text" name="fid" value="36" /></td>
                        </tr>
                        <tr>
                            <td width="150px">用户ID(uid)</td>
                        ...
                        <tr>
                            <td width="150px">分类信息id(sortid)</td>
                            <td><input type="text" name="sortid" value="" /></td>
                        </tr>
                        <tr>
                            <td width="150px">信息有效期(typeexpiration)</td>
                            <td><input type="text" name="typeexpiration" value="604800" /></td>
                        </tr>
                        <tr>
                            <td width="150px">地区(diqu)</td>
                            <td><input type="text" name="diqu" value="2" /></td>
                        </tr>
                        <tr>
                            <td width="150px">详细信息(xiangxi)</td>
                            <td><textarea name="xiangxi" rows="6" cols="44">
吃了吗吃了吗吃了吗吃了吗吃了吗吃了吗
                            </textarea></td>
                        </tr>
                        <tr>
                            <td width="150px">邮件(email)</td>
                            <td><input type="text" name="email" value="ff@163.com" /></td>
                        </tr>
                        <tr>
                            <td width="150px">电话(tel)</td>
                            <td><input type="text" name="tel" value="119" /></td>
                        </tr>
                        <tr>
                            <td width="150px">QQ(qq)</td>
                            <td><input type="text" name="qq" value="1144555" /></td>
                        </tr>
